modifier_pudge_meat_hook_tiny_lua = class({})
--------------------------------------------------------------------------------

function modifier_pudge_meat_hook_tiny_lua:IsDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_meat_hook_tiny_lua:IsStunDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_meat_hook_tiny_lua:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------

function modifier_pudge_meat_hook_tiny_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_pudge_meat_hook_tiny_lua:DeclareFunctions()
	local funcs = {
...
function modifier_pudge_meat_hook_tiny_lua:GetOverrideAnimation( params )
	return ACT_DOTA_FLAIL
end

--------------------------------------------------------------------------------

function modifier_pudge_meat_hook_tiny_lua:CheckState()
	if IsServer() then
...
function modifier_pudge_meat_hook_tiny_lua:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_pudge_meat_hook_tiny_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
		for k,v in pairs(self:GetAbility().Projectile) do
			if self:GetParent()== v.hVictim then
