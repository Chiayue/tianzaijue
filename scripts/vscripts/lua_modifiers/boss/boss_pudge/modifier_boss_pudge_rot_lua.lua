modifier_boss_pudge_rot_lua = class({})
--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:IsDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:IsAura()
...
function modifier_boss_pudge_rot_lua:GetModifierAura()
	return "modifier_boss_pudge_rot_lua"
end

--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end

--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:GetAuraRadius()
	return self.rot_radius
end

--------------------------------------------------------------------------------

function modifier_boss_pudge_rot_lua:OnCreated( kv )
...
function modifier_boss_pudge_rot_lua:OnDestroy()
	if IsServer() then
...
function modifier_boss_pudge_rot_lua:DeclareFunctions()
	local funcs = {
...
function modifier_boss_pudge_rot_lua:GetModifierMoveSpeedBonus_Percentage( params )
	if self:GetParent() == self:GetCaster() then
		return 0
	end
...
function modifier_boss_pudge_rot_lua:OnIntervalThink()
	if IsServer() then
		local flDamagePerTick = self.rot_tick * self.rot_damage

		if self:GetCaster():IsAlive() and self:GetCaster() ~= self:GetParent() then
			local damage = {
