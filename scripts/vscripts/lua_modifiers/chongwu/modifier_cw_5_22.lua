...
modifier_cw_5_22 = class({})

-----------------------------------------------------------------------------------------
function modifier_cw_5_22:GetTexture()
	return "item_treasure/杀猪刀"
end

function modifier_cw_5_22:IsHidden()
	return true
end
----------------------------------------

function modifier_cw_5_22:OnCreated( kv )
...
function modifier_cw_5_22:OnRefresh()
	if IsServer() then
...
function modifier_cw_5_22:OnDestroy()
	if IsServer() then
		local unitKey = tostring(EntityHelper.getEntityIndex(self:GetParent()))
		if not self:GetParent().cas_table then
			self:GetParent().cas_table = {}
...
function modifier_cw_5_22:GetAttributes()
