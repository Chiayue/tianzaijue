...
modifier_cw_2_101 = class({})

-----------------------------------------------------------------------------------------
function modifier_cw_2_101:GetTexture()
	return "item_treasure/杀猪刀"
end

function modifier_cw_2_101:IsHidden()
	return true
end
----------------------------------------

function modifier_cw_2_101:OnCreated( kv )
...
function modifier_cw_2_101:OnRefresh()
	if IsServer() then
...
function modifier_cw_2_101:OnDestroy()
	if IsServer() then
		local unitKey = tostring(EntityHelper.getEntityIndex(self:GetParent()))
		if not self:GetParent().cas_table then
			self:GetParent().cas_table = {}
...
function modifier_cw_2_101:GetAttributes()
