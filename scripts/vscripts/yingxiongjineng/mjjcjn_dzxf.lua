function dzxf( keys )
	...
	if caster.dzxf_baseDamage == nil then
		caster.dzxf_baseDamage = 0
	end
	if caster.dzxf_damage == nil then
		caster.dzxf_damage = 0
	end

	local baseDamage2 = baseDamage + caster.dzxf_baseDamage
	i = i + caster.dzxf_damage
