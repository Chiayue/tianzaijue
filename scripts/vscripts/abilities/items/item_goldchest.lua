item_goldchest = class({})

--------------------------------------------------------------------------------
function item_goldchest:GetBehavior()
	return DOTA_ABILITY_BEHAVIOR_IMMEDIATE
end
--------------------------------------------------------------------------------
function item_goldchest:CanUnitPickUp(hUnit)
...
--------------------------------------------------------------------------------
function item_goldchest:OnSpellStart()
	if IsServer() then
		local hCaster = self:GetCaster()
		PlayerData:ModifyGold(hCaster:GetPlayerOwnerID(), GetItemCost(self:GetName()), true)
