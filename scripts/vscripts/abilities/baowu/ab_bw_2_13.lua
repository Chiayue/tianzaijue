...
function ab_bw_2_13:GetIntrinsicModifierName()
	return "modifier_bw_2_13"
end

function ab_bw_2_13:OnProjectileHit_ExtraData(target, vLocation, extraData)
...
function ab_bw_2_13:CreateMoonGlaive(originalTarget, extraData)
