LinkLuaModifier("modifier_nian_1", "abilities/boss/nian_1.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
if nian_1 == nil then
	nian_1 = class({})
end
function nian_1:GetIntrinsicModifierName()
	return "modifier_nian_1"
end
---------------------------------------------------------------------
--Modifiers
if modifier_nian_1 == nil then
	modifier_nian_1 = class({}, nil, eom_modifier)
end
function modifier_nian_1:IsHidden()
	return true
end
function modifier_nian_1:OnCreated(params)
	self:UpdateValues()
end
function modifier_nian_1:OnRefresh(params)
	self:UpdateValues()
end

function modifier_nian_1:UpdateValues()
...
function modifier_nian_1:EDeclareFunctions()
	return {
		[MODIFIER_EVENT_ON_ATTACK_LANDED] = { self:GetParent(), nil },
	}
end

function modifier_nian_1:OnAttackLanded(params)
