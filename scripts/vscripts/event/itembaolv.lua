...
_G.Rare_Pro_Value={
	smhf={{10,30},{50,100},{100,300},{400,800},{900,1500},{1600,2500},{2600,4000}},	--生命回复
	mfhf={{1,2},{3,4},{4,6},{7,8},{9,10},{11,14},{15,18}},			--魔法回复
	smz={{200,600},{800,2000},{3000,5000},{6000,12000},{14000,25000},{30000,50000},{55000,80000}},	--生命值
	mfz={{10,20},{30,40},{40,60},{70,80},{90,100},{110,140},{150,180}},								--魔法值
	bgjyglhx={{10,30},{50,100},{100,300},{400,800},{1000,2000},{3000,5000},{5500,7500}},	--被攻击有20%概率回血
	bgjyglhl={{1,4},{5,8},{9,12},{13,16},{17,20},{21,26},{27,32}},		--被攻击有20%概率回蓝
	damage={{20,60},{100,300},{600,1000},{1200,2000},{3000,6000},{7000,12000},{13000,20000}},	--攻击力
	hj={{1,4},{5,10},{12,16},{18,24},{28,32},{36,40},{44,48}},				--护甲
	mfkx={{1,3},{3,5},{5,7},{7,9},{9,11},{11,13},{13,15}},			--魔法抗性
	jnsh={{1,5},{6,10},{11,15},{16,25},{26,35},{36,45},{46,60}},			--技能伤害
	ll={{10,30},{40,100},{120,240},{360,800},{900,1350},{1500,2200},{2300,3500}},		--力量
