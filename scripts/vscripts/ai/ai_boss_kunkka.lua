...
function Spawn( entityKeyValues )
	...
	OneAbility = thisEntity:FindAbilityByName( "boss_kunkka_callship" )--肉勾
	
	

	thisEntity.timeOfLastAggro = GameRules:GetGameTime()
	thisEntity:SetContextThink( "BosskunkkaThink", BosskunkkaThink, 1 )
end

function BosskunkkaThink()
	...
	if OneAbility ~= nil and OneAbility:IsCooldownReady() and thisEntity:GetHealthPercent() < 40  then
