...
function Spawn( entityKeyValues )
	...
	OneAbility = thisEntity:FindAbilityByName( "boss_one_storm_lua" )
	TwoAbility = thisEntity:FindAbilityByName( "boss_shakeground_lua" )
	ThreeAbility = thisEntity:FindAbilityByName( "boss_one_bloodfire_lua" )
