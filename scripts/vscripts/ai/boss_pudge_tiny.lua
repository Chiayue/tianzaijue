...
function Spawn( entityKeyValues )
	...
	thisEntity:SetContextThink( "BosspudgetinyThink", BosspudgetinyThink, 1 )
end

function BosspudgetinyThink()
	...
	if ThreeAbility ~= nil and ThreeAbility:IsCooldownReady()  then
